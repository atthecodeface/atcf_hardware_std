...
SRAM_WRAPPER(512, 32, 0)
SRAM_WRAPPER(512, 64, 0)

SRAM_WRAPPER(16384, 8, 8)
SRAM_WRAPPER(8192, 16, 8)
SRAM_WRAPPER(4096, 32, 8)
SRAM_WRAPPER(2048, 64, 8)

SRAM_WRAPPER(8192, 32, 32)

SRAM_WRAPPER(65536, 8, 8)
SRAM_WRAPPER(32768, 16, 8)
SRAM_WRAPPER(16384, 32, 8)
SRAM_WRAPPER(8192, 64, 8)
...
srams__init( void )
{
    ...
    SRAM_REGISTER(512, 32, 0);
    SRAM_REGISTER(512, 64, 0);

    SRAM_REGISTER(16384, 8, 8);
    SRAM_REGISTER_WE(8192, 16, 8);
    SRAM_REGISTER_WE(4096, 32, 8);
    SRAM_REGISTER_WE(2048, 64, 8);

    SRAM_REGISTER(8192, 32, 32);
    
    SRAM_REGISTER(65536, 8, 8);
    SRAM_REGISTER_WE(32768, 16, 8);
    SRAM_REGISTER_WE(16384, 32, 8);
    SRAM_REGISTER_WE(8192, 64, 8);
